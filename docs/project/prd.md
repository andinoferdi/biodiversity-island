...
- `In Progress` (Hari 6–9, lanjutan): hubungan predator–mangsa serta tiga krisis ekosistem
...
| Hari 6–9 Bioma & Spesies | Tiga bioma, enam spesies GLB, animasi, predator–mangsa, tiga krisis | In Progress — biome terrain dan animal species Implemented (tiga bioma, sumber daya per bioma, enam spesies GLB dengan deer beranimasi); lihat `docs/feature/biome-terrain/biome-terrain.md` dan `docs/feature/animal-species/animal-species.md`. Predator–mangsa dan krisis belum ada |
